...
ROM[8'h73] = {16'h3e00,8'h01,1'b0};//00
ROM[8'h74] = {16'h3e01,8'hbb,1'b0};//ba
ROM[8'h75] = {16'h3e02,8'hf0,1'b0};//d0
...
ROM[8'ha1] = {16'h3E08,8'h80,1'b0};
ROM[8'ha2] = {16'h3E09,8'h2a,1'b0};
ROM[8'ha3] = {16'h3221,8'h66,1'b0};
end 
// write is unused
