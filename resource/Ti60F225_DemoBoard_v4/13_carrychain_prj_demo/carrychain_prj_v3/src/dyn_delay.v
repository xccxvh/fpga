...
(* syn_preserve = "true" *)wire dyn_ena_inv1;
(* syn_preserve = "true" *)wire dyn_ena_inv2;
reg dyn_ena_r = 'd0;
always @( negedge clk or negedge rst_n )
begin
		if( !rst_n ) 
...
assign dly_ena_inv1 = ~dyn_ena_r;
assign dyn_ena_inv2 = ~dly_ena_inv1;
assign dyn_ena = dyn_ena_inv2;
reg dyn_inc_r1;
(* syn_preserve = "true" *)wire dyn_inc_inv1;
(* syn_preserve = "true" *)wire dyn_inc_inv2;
always @( posedge clk )
begin
	dyn_inc_r1 <= dly_inc_r	;  
end
assign dyn_inc_inv1 = ~dyn_inc_r1;
assign dyn_inc_inv2 = ~dyn_inc_inv1;
assign dyn_inc = dyn_inc_inv2;
