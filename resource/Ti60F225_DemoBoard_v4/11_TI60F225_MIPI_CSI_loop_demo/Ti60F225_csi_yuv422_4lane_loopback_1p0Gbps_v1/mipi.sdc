...
create_clock -period 5.000 mipi_dphy_rx_clk_CLKOUT
create_clock -period 15 pixel_clk
create_clock -period 5.000 mipi_dphy_tx_SLOWCLK
...
create_clock -period 50.00 [get_ports {jtag_inst1_TCK}]
create_clock -period 50.00 [get_ports {jtag_inst1_DRCK}]
