...
localparam PACKET_SEQUENCES = 2;
localparam HS_CMD_FIFO_DEPTH = 128;
localparam LP_CMD_FIFO_DEPTH = 128;
localparam LP_CMD_RDATAFIFO_DEPTH = 128;
localparam ENABLE_BIDIR = 1'b0;
