...
port (
    ...
    Tx_LP_D_P : out std_logic;
    Tx_LP_D_P_OE : out std_logic;
    Tx_LP_D_N : out std_logic;
    Tx_LP_D_N_OE : out std_logic;
    ...
    pixel_vc : out std_logic_vector(1 downto 0);
    pixel_format : out std_logic_vector(5 downto 0);
    datatype : out std_logic_vector(5 downto 0);
    video_format : in std_logic_vector(5 downto 0);
    irq : out std_logic
);
end component mipi_dsi_rx;

---------------------- End COMPONENT Declaration ------------
------------- Begin Cut here for INSTANTIATION Template -----
u_mipi_dsi_rx : mipi_dsi_rx
port map (
    reset_n => reset_n,
    clk => clk,
