...
`define DBG_MODULE_UUID _daf66c25c527492d81a19fbf0ddb567d
...
module debug_profile_edb_top (
    ...
    output bscan_TDO,
    input  LVDS_TX_clk,
    input  [7:0] LVDS_TX_lvds_tx_data0,
    input  [7:0] LVDS_TX_lvds_tx_data1,
    input  [7:0] LVDS_TX_lvds_tx_data2,
    input  [7:0] LVDS_TX_lvds_tx_data3,
    input  LVDS_RX_clk,
    input  [7:0] LVDS_RX_lvds_rx_data_slip0,
    input  [7:0] LVDS_RX_lvds_rx_data_slip1,
    input  [7:0] LVDS_RX_lvds_rx_data_slip2,
    input  [7:0] LVDS_RX_lvds_rx_data_slip3,
    input  LVDS_RX_stat0,
    input  LVDS_RX_stat1,
    input  LVDS_RX_stat2,
    input  LVDS_RX_stat3,
    input  vio_ctrl_status_clk,
    input  vio_ctrl_status_pll_locked,
    input  vio_ctrl_status_rx_heartbeat,
    input  vio_ctrl_status_tx_heartbeat,
    input  vio_ctrl_status_det_pass,
    input  vio_ctrl_status_stat0,
    input  vio_ctrl_status_stat1,
    input  vio_ctrl_status_stat2,
    input  vio_ctrl_status_stat3,
    output vio_ctrl_status_data_source,
    output [7:0] vio_ctrl_status_lvds_tx_data,
    output vio_ctrl_status_bitslip_binding,
    output vio_ctrl_status_bitslip_all,
    output vio_ctrl_status_bitslip0,
    output vio_ctrl_status_bitslip1,
    output vio_ctrl_status_bitslip2,
    output vio_ctrl_status_bitslip3,
    input  vio_tx_data_clk,
    input  [7:0] vio_tx_data_lvds_tx_data0,
    input  [7:0] vio_tx_data_lvds_tx_data1,
    input  [7:0] vio_tx_data_lvds_tx_data2,
    input  [7:0] vio_tx_data_lvds_tx_data3,
    input  vio_rx_data_clk,
    input  [7:0] vio_rx_data_lvds_rx_data0,
    input  [7:0] vio_rx_data_lvds_rx_data1,
    input  [7:0] vio_rx_data_lvds_rx_data2,
    input  [7:0] vio_rx_data_lvds_rx_data3,
    input  [7:0] vio_rx_data_lvds_rx_data_slip0,
    input  [7:0] vio_rx_data_lvds_rx_data_slip1,
    input  [7:0] vio_rx_data_lvds_rx_data_slip2,
    input  [7:0] vio_rx_data_lvds_rx_data_slip3
);
    ...
    wire LVDS_TX_module_select;
    wire LVDS_TX_module_inhibit;
    wire LVDS_TX_module_tdo;

    wire LVDS_RX_module_select;
    wire LVDS_RX_module_inhibit;
    wire LVDS_RX_module_tdo;

    wire vio_ctrl_status_module_select;
    wire vio_ctrl_status_module_inhibit;
    wire vio_ctrl_status_module_tdo;

    wire vio_tx_data_module_select;
    wire vio_tx_data_module_inhibit;
    wire vio_tx_data_module_tdo;

    wire vio_rx_data_module_select;
    wire vio_rx_data_module_inhibit;
    wire vio_rx_data_module_tdo;

    assign LVDS_TX_module_select        = edb_module_selects[0];
    assign edb_module_inhibit[0]    = LVDS_TX_module_inhibit;
    assign edb_module_tdo[0]        = LVDS_TX_module_tdo;
    assign LVDS_RX_module_select        = edb_module_selects[1];
    assign edb_module_inhibit[1]    = LVDS_RX_module_inhibit;
    assign edb_module_tdo[1]        = LVDS_RX_module_tdo;
    assign vio_ctrl_status_module_select        = edb_module_selects[2];
    assign edb_module_inhibit[2]    = vio_ctrl_status_module_inhibit;
    assign edb_module_tdo[2]        = vio_ctrl_status_module_tdo;
    assign vio_tx_data_module_select        = edb_module_selects[3];
    assign edb_module_inhibit[3]    = vio_tx_data_module_inhibit;
    assign edb_module_tdo[3]        = vio_tx_data_module_tdo;
    assign vio_rx_data_module_select        = edb_module_selects[4];
    assign edb_module_inhibit[4]    = vio_rx_data_module_inhibit;
    assign edb_module_tdo[4]        = vio_rx_data_module_tdo;
    ...
    `DBG_MODULE_NAME(edb_la_top) #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h43507008b5404eea94d37522b9faef87 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 8 ),
        ...
        .edb_module_select      ( LVDS_TX_module_select  ),
        .edb_module_inhibit     ( LVDS_TX_module_inhibit ),
        .edb_module_tdo         ( LVDS_TX_module_tdo ),
        ...
        .trig_out               (  ),
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( LVDS_TX_lvds_tx_data0 ),
        .probe1                 ( LVDS_TX_lvds_tx_data1 ),
        .probe2                 ( LVDS_TX_lvds_tx_data2 ),
        .probe3                 ( LVDS_TX_lvds_tx_data3 )
    );
    ...
    `DBG_MODULE_NAME(edb_la_top) #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h501e047431954bc28a7ac1cb700791d0 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 8 ),
        ...
        .bscan_UPDATE                   ( bscan_UPDATE ),
        .edb_user_dr            ( edb_user_dr ),
        .edb_module_select      ( LVDS_RX_module_select  ),
        .edb_module_inhibit     ( LVDS_RX_module_inhibit ),
        .edb_module_tdo         ( LVDS_RX_module_tdo ),
        .edb_soft_reset         ( edb_soft_reset ),
        .clk                    ( LVDS_RX_clk ),
        .trig_in                ( 1'b0 ),
        .trig_in_ack            (  ),
        .trig_out               (  ),
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( LVDS_RX_lvds_rx_data_slip0 ),
        .probe1                 ( LVDS_RX_lvds_rx_data_slip1 ),
        .probe2                 ( LVDS_RX_lvds_rx_data_slip2 ),
        .probe3                 ( LVDS_RX_lvds_rx_data_slip3 ),
        .probe4                 ( LVDS_RX_stat0 ),
        .probe5                 ( LVDS_RX_stat1 ),
        .probe6                 ( LVDS_RX_stat2 ),
        .probe7                 ( LVDS_RX_stat3 )
    );

    `DBG_MODULE_NAME(edb_vio_top) #(
        .NUM_PROBE_IN           ( 8 ),
        .NUM_PROBE_OUT          ( 8 ),
        .UUID           ( 128'h4df880dc5f604b0f98d726b643b6d17a ),
        .PROBE_IN0_WIDTH        ( 1 ),
        .PROBE_IN1_WIDTH        ( 1 ),
        .PROBE_IN2_WIDTH        ( 1 ),
        .PROBE_IN3_WIDTH        ( 1 ),
        ...
        .bscan_UPDATE           ( bscan_UPDATE ),
        .edb_user_dr        ( edb_user_dr ),
        .edb_module_select  ( vio_ctrl_status_module_select  ),
        .edb_module_inhibit ( vio_ctrl_status_module_inhibit ),
        .edb_module_tdo     ( vio_ctrl_status_module_tdo ),
        .edb_soft_reset     ( edb_soft_reset ),
        .clk                ( vio_ctrl_status_clk ),
        .probe_in0          ( vio_ctrl_status_pll_locked ),
        .probe_in1          ( vio_ctrl_status_rx_heartbeat ),
        .probe_in2          ( vio_ctrl_status_tx_heartbeat ),
        .probe_in3          ( vio_ctrl_status_det_pass ),
        .probe_in4          ( vio_ctrl_status_stat0 ),
        .probe_in5          ( vio_ctrl_status_stat1 ),
        .probe_in6          ( vio_ctrl_status_stat2 ),
        .probe_in7          ( vio_ctrl_status_stat3 ),
        .probe_in8          ( 1'b0 ),
        .probe_in9          ( 1'b0 ),
        .probe_in10         ( 1'b0 ),
        .probe_in11         ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio_ctrl_status_data_source ),
        .probe_out1         ( vio_ctrl_status_lvds_tx_data ),
        .probe_out2         ( vio_ctrl_status_bitslip_binding ),
        .probe_out3         ( vio_ctrl_status_bitslip_all ),
        .probe_out4         ( vio_ctrl_status_bitslip0 ),
        .probe_out5         ( vio_ctrl_status_bitslip1 ),
        .probe_out6         ( vio_ctrl_status_bitslip2 ),
        .probe_out7         ( vio_ctrl_status_bitslip3 ),
        .probe_out8         (  ),
        .probe_out9         (  ),
        .probe_out10            (  ),
        .probe_out11            (  ),
    ...
    `DBG_MODULE_NAME(edb_vio_top) #(
        .NUM_PROBE_IN           ( 4 ),
        .NUM_PROBE_OUT          ( 0 ),
        .UUID           ( 128'h42647261548e4288b010b8a61705a0e3 ),
        .PROBE_IN0_WIDTH        ( 8 ),
        .PROBE_IN1_WIDTH        ( 8 ),
        .PROBE_IN2_WIDTH        ( 8 ),
        .PROBE_IN3_WIDTH        ( 8 )
        ...
        .bscan_UPDATE           ( bscan_UPDATE ),
        .edb_user_dr        ( edb_user_dr ),
        .edb_module_select  ( vio_tx_data_module_select  ),
        .edb_module_inhibit ( vio_tx_data_module_inhibit ),
        .edb_module_tdo     ( vio_tx_data_module_tdo ),
        .edb_soft_reset     ( edb_soft_reset ),
        .clk                ( vio_tx_data_clk ),
        .probe_in0          ( vio_tx_data_lvds_tx_data0 ),
        .probe_in1          ( vio_tx_data_lvds_tx_data1 ),
        .probe_in2          ( vio_tx_data_lvds_tx_data2 ),
        .probe_in3          ( vio_tx_data_lvds_tx_data3 ),
        .probe_in4          ( 1'b0 ),
        .probe_in5          ( 1'b0 ),
        .probe_in6          ( 1'b0 ),
        .probe_in7          ( 1'b0 ),
    ...
    `DBG_MODULE_NAME(edb_vio_top) #(
        .NUM_PROBE_IN           ( 8 ),
        .NUM_PROBE_OUT          ( 0 ),
        .UUID           ( 128'ha7d4286dd3f9492aa0a92b7135a01cfc ),
        .PROBE_IN0_WIDTH        ( 8 ),
        .PROBE_IN1_WIDTH        ( 8 ),
        .PROBE_IN2_WIDTH        ( 8 ),
        .PROBE_IN3_WIDTH        ( 8 ),
        ...
        .bscan_UPDATE           ( bscan_UPDATE ),
        .edb_user_dr        ( edb_user_dr ),
        .edb_module_select  ( vio_rx_data_module_select  ),
        .edb_module_inhibit ( vio_rx_data_module_inhibit ),
        .edb_module_tdo     ( vio_rx_data_module_tdo ),
        .edb_soft_reset     ( edb_soft_reset ),
        .clk                ( vio_rx_data_clk ),
        .probe_in0          ( vio_rx_data_lvds_rx_data0 ),
        .probe_in1          ( vio_rx_data_lvds_rx_data1 ),
        .probe_in2          ( vio_rx_data_lvds_rx_data2 ),
        .probe_in3          ( vio_rx_data_lvds_rx_data3 ),
        .probe_in4          ( vio_rx_data_lvds_rx_data_slip0 ),
        .probe_in5          ( vio_rx_data_lvds_rx_data_slip1 ),
        .probe_in6          ( vio_rx_data_lvds_rx_data_slip2 ),
        .probe_in7          ( vio_rx_data_lvds_rx_data_slip3 ),
        .probe_in8          ( 1'b0 ),
        .probe_in9          ( 1'b0 ),
        .probe_in10         ( 1'b0 ),
        .probe_in11         ( 1'b0 ),
