...
//             if(sync_r0) begin
//             case( cfg_alen_r)
//                 8'd1 : first_burst_cnt <= |first_4k_burst_len[0]  ? {7'd0,first_4k_burst_len[0]}-'d1  :cfg_alen_r;
//                 8'd3 : first_burst_cnt <= |first_4k_burst_len[1:0]? {6'd0,first_4k_burst_len[1:0]}-'d1:cfg_alen_r;
//                 8'd7 : first_burst_cnt <= |first_4k_burst_len[2:0]? {5'd0,first_4k_burst_len[2:0]}-'d1:cfg_alen_r;
//                 8'd15: first_burst_cnt <= |first_4k_burst_len[3:0]? {4'd0,first_4k_burst_len[3:0]}-'d1:cfg_alen_r;
//                 8'd31: first_burst_cnt <= |first_4k_burst_len[4:0]? {3'd0,first_4k_burst_len[4:0]}-'d1:cfg_alen_r;
//                 8'd63: first_burst_cnt <= |first_4k_burst_len[5:0]? {2'd0,first_4k_burst_len[5:0]}-'d1:cfg_alen_r;
//                 8'd127:first_burst_cnt <= |first_4k_burst_len[6:0]? {1'd0,first_4k_burst_len[6:0]}-'d1:cfg_alen_r;
//                 8'd255:first_burst_cnt <= |first_4k_burst_len[7:0]? {first_4k_burst_len[7:0]}-'d1     :cfg_alen_r;
//                 default:;
//             endcase
//             end 
//         end 
...
// 		if(sync_r0) begin
// 		case( cfg_alen_r)
// 			8'd1 : last_burst_cnt  <= |last_4k_burst_len[0]  ? {7'd0,last_4k_burst_len[0]}-'d1  :cfg_alen_r;
// 			8'd3 : last_burst_cnt  <= |last_4k_burst_len[1:0]? {6'd0,last_4k_burst_len[1:0]}-'d1:cfg_alen_r;
// 			8'd7 : last_burst_cnt  <= |last_4k_burst_len[2:0]? {5'd0,last_4k_burst_len[2:0]}-'d1:cfg_alen_r;
// 			8'd15: last_burst_cnt  <= |last_4k_burst_len[3:0]? {4'd0,last_4k_burst_len[3:0]}-'d1:cfg_alen_r;
// 			8'd31: last_burst_cnt  <= |last_4k_burst_len[4:0]? {3'd0,last_4k_burst_len[4:0]}-'d1:cfg_alen_r;
// 			8'd63: last_burst_cnt  <= |last_4k_burst_len[5:0]? {2'd0,last_4k_burst_len[5:0]}-'d1:cfg_alen_r;
//             8'd127: last_burst_cnt <= |last_4k_burst_len[6:0]? {2'd0,last_4k_burst_len[6:0]}-'d1:cfg_alen_r;
//             8'd255: last_burst_cnt <= |last_4k_burst_len[7:0]? {2'd0,last_4k_burst_len[7:0]}-'d1:cfg_alen_r;
// 			default:;
// 		endcase
// 		end 
//     end 
...
// 		if(sync_r2) begin
// 		case( cfg_alen_r)
// 			8'd1 : burst_num <= align_burst_num[24:1] + 'd2 ;
// 			8'd3 : burst_num <= align_burst_num[24:2] + 'd2 ;
// 			8'd7 : burst_num <= align_burst_num[24:3] + 'd2 ;
// 			8'd15: burst_num <= align_burst_num[24:4] + 'd2 ;
// 			8'd31: burst_num <= align_burst_num[24:5] + 'd2 ;
// 			8'd63: burst_num <= align_burst_num[24:6] + 'd2 ;
//             8'd127: burst_num <= align_burst_num[24:7] + 'd2 ;
//             8'd255: burst_num <= align_burst_num[24:8] + 'd2 ;
// 			default:;
// 		endcase
// 		end 
//     end 
...
always @(posedge axi_clk or negedge rst_n) 
begin
	if (!rst_n) 									        ddr_addr <= start_addr_r;
	else if( sync_r2 )						                ddr_addr <= start_addr_r;
    // else if(rd_addr_en &&burst_last)                        ddr_addr <= start_addr_r;// burst_num == total_burst_num+1
...
always @( posedge axi_clk or negedge rst_n  )
begin
    if( !rst_n ) 							                    ddr_arlen 	<= BURST_LEN;//cfg_alen;
